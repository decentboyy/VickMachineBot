...
BOT_TOKEN = os.environ.get("5058249365:AAGpAKZV8yV0aBXCaVkVOCEtWRIJQnv7V40", None) 
MONGO_URL = os.environ.get("mongodb+srv://abc:abcd@cluster0.dzijde4.mongodb.net/?retryWrites=true&w=majority", None)
